 ...
 * contains methods to add, remove, load, and get students from directory and save directory
 * using sorted lists
 * 
...
public class StudentDirectory {
	 ...
	 * list are listed unless saved by the user.
	 */
	...
	public boolean addStudent(String firstName, String lastName, String id, String email, String password, String repeatPassword, int maxCredits) {
		String hashPW = "";
		String repeatHashPW = "";
		// checks to ensure password is valid
		...
		// checks to make sure this student is not already in the directory
	...
	public boolean removeStudent(String studentId) {
		// checks to make sure the student exists in the directory
		for (int i = 0; i < studentDirectory.size(); i++) {
			User s = studentDirectory.get(i);
			// removes student if they are in the directory
	...
	/**
	 * gets student using their id and returns the Student object
	 * @param id student id
